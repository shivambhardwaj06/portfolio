...
const contacts = [
  { label: 'LINKEDIN', type: 'social', link: 'https://linkedin.com/in/shivambhardwaj2006' },
  { label: 'GITHUB', type: 'social', link: 'https://github.com/shivambhardwaj06' },
]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div {...fadeInUp} className="mb-12 lg:mb-16 max-w-2xl">
          <h3 className="text-xl md:text-2xl lg:text-3xl text-white font-light leading-tight mb-4">
            OPEN TO DATA SCIENCE<br />
            AND ML ENGINEERING<br />
            OPPORTUNITIES
          </h3>
          <p className="text-sm text-gray-500 tracking-widest uppercase">
            INTERNSHIPS & INTERESTING COLLABORATIONS
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 md:gap-16">
            <a
              href="mailto:shiva.bhardwaj.mks@gmail.com"
            ...
            <a
              href="https://github.com/shivambhardwaj06"
              target="_blank"
              rel="noopener noreferrer"
              className="text-lg lg:text-xl text-gray-300 hover:text-white transition-colors underline underline-offset-4"
            >
            ...
            <a
              href="https://linkedin.com/in/shivambhardwaj2006"
              target="_blank"
              rel="noopener noreferrer"
              className="text-lg lg:text-xl text-gray-300 hover:text-white transition-colors underline underline-offset-4"
            >
        ...
        >
          <p className="text-xs text-gray-600">
            © {new Date().getFullYear()} Shivam Bhardwaj. All rights reserved.
          </p>
          <p className="text-xs text-gray-600">Data Scientist / ML Engineer</p>
        </motion.footer>
      </div>
    </section>
  )
