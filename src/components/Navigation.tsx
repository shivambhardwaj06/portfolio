...
const socialLinks = [
  { label: 'Mail', href: 'mailto:shiva.bhardwa.mks@gmail.com' },
  { label: 'GitHub', href: 'https://github.com/shivambhardwaj06' },
  { label: 'LinkedIn', href: 'https://linkedin.com/in/shivambhardwaj2006' },
]
