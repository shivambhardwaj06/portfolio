...
const talks = [
  {
    title: 'Getting Your First Data Science Role',
    event: 'Campus ML Club',
    year: '2025',
    link: '#',
  },
  {
    title: 'Deploying ML Models with FastAPI and Docker',
    event: 'Local PyData Meetup',
    year: '2025',
    link: '#',
  },
  {
    title: 'Intro to Deep Learning for Beginners',
    event: 'Student Tech Fest',
    year: '2024',
    link: '#',
  },
  {
    title: 'From SQL to Machine Learning: A Roadmap',
    ...
    <section id="speaking" className="section-padding bg-[#0d0d0d]">
      <div className="max-w-7xl mx-auto">
        <motion.div {...fadeInUp} className="mb-16">
          <span className="text-sm text-gray-500 tracking-widest uppercase">Talks &amp; Workshops</span>
