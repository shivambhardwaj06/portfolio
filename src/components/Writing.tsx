...
const articles = [
  {
    title: 'A Practical Guide to Fine-Tuning Small LLMs',
    publication: 'Personal Blog',
    year: '2026',
    link: '#',
  },
  {
    title: 'Why Feature Engineering Still Beats Bigger Models',
  ...
  {
    title: 'Understanding Transformers Without the Hype',
    publication: 'Medium',
    year: '2024',
    link: '#',
  },
